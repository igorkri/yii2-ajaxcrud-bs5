        ...
        if($request->isAjax){
            ...
            return [
                    ...
                    'footer'=> Html::button('Закрити',['class'=>'btn btn-default pull-left','data-bs-dismiss'=>"modal"]).
                            Html::a('Редагувати',['update','<?= substr($actionParams,1) ?>'=><?= $actionParams ?>],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
        }else{
    ...
    public function actionUpdate(<?= $actionParams ?>)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Редагування <?= $modelClass ?> #".<?= $actionParams ?>,
